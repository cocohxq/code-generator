...
<mapper namespace="${commonValueStack.getValue(tableCamelNameMax + "Mapper.classPath")!""}">
    ...
    <insert id="insert" parameterType="${commonValueStack.getValue(tableCamelNameMax + "DO.classPath")!""}">
        insert into ${dbName}.${tableMeta.table.tableName}(
            <trim prefix="" suffixOverrides=",">
            <#list commonValueStack.getFieldsWithoutExclude(tableMeta.fields,"id",createTimeStr,updateTimeStr,deleteStr,modifierIdStr) as field>
                ${field.column.columnName},
            </#list>
    ...
    <update id="updateById" parameterType="${commonValueStack.getValue(tableCamelNameMax + "DO.classPath")!""}">
        ...
        <#list commonValueStack.getFieldsWithoutExclude(tableMeta.fields,"id",createTimeStr,updateTimeStr,deleteStr,creatorIdStr) as field>
            <if test="${field.fieldCamelNameMin} != null">
    ...
    <update id="updateForEditById" parameterType="${commonValueStack.getValue(tableCamelNameMax + "DO.classPath")!""}">
        update ${dbName}.${tableMeta.table.tableName}
        <trim prefix="set" suffixOverrides=",">
        <#list commonValueStack.getFieldsWithoutExclude(tableMeta.fields,"id",createTimeStr,updateTimeStr,deleteStr,creatorIdStr) as field>
            ${field.column.columnName}=${r'#'}{${field.fieldCamelNameMin}},
    ...
    <update id="batchUpdateForEditById" parameterType="java.util.List">
        <foreach collection="list" item="item" open=" " separator=" " close="">
            update ${dbName}.${tableMeta.table.tableName}
            <trim prefix="set" suffixOverrides=",">
            <#list commonValueStack.getFieldsWithoutExclude(tableMeta.fields,"id",createTimeStr,updateTimeStr,deleteStr,creatorIdStr) as field>
    ...
    <update id="deleteById" parameterType="java.lang.Long">
        update ${dbName}.${tableMeta.table.tableName}
        set <#list commonValueStack.getSpecifiedFields(tableMeta.fields,deleteStr,modifierIdStr) as field>${field.column.columnName}=1</#list>,
        <#list commonValueStack.getSpecifiedFields(tableMeta.fields,updateTimeStr) as field>
            ${field.column.columnName}=now()
        </#list>
        where id = ${r'#'}{id}
